...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Java, C, C++, Swift, SQL, Latex, Arduino, Raspberry Pi} \\
     \textbf{Frameworks}{: Docker, SwiftUI} \\
     \textbf{Developer Tools}{: Git/GitHub, Docker/DockerHub, VS Code, Xcode, JupyterLab, RStudio, TeXShop} \\
}}
\end{itemize}
