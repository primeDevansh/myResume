...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Java, C/C++, R, Rust, Swift, Arduino, Raspberry Pi, SQL, Latex} \\
...
\section{Extra-Curricular Activities}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Sports:}{ Actively involved in participating and organising basketball and cricket events} \\
     \textbf{YouTube:}{ Technical YouTube channel with 100+ subscribers} \\
     \textbf{Blog:}{ Occasionally blog about life lessons I lean and short stories I write}
    }}
 \end{itemize}
