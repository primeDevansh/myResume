...
\section{Projects}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Used Nvidia's H100 GPUs on IIITD's rack servers for LLM inferencing}
            ...
            \resumeItem{Generated RDMA traffic for ditributed Llama-2 inferencing workload using PyTorch library's torchrun functionality}
          \resumeItemListEnd
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Used the Scikit-learn package to predict whether we can correctly classify a song's genre based on features such as danceability, energy, acousticness and tempo}
...
\section{Extra-Curricular Activities}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    % %  \textbf{YouTube:}{ Passionate YouTube content creator with 100+ subscribers, featuring technical and diverse content} \\
     \textbf{}{Engaged in regular \& independent community service involving the preparation and distribution of meals to individuals in need} \\
    }}
 \end{itemize}
